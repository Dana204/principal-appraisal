		...
		<section
			...
			<div className='about-section__details'>
				...
				<p className='text-muted'>
					We offer Proven Expertise in Web, Mobile & Client-Server
					Application Development, Consultancy Services and Systems
					Integration,and best of Breed Hardware Solutions from
					partners like Lenovo, Zebra, Kaspersky, Lexmark & Honeywell.
					This blend of Expertise and Partnerships added to our client
					centric philosophy makes us the perfect choice for your IT
					Partner.
				</p>

				<ul
					role='list'
					className='grid-containe'>
					<li>
						<span>10+</span>
						<h6>Team Members</h6>
					</li>
